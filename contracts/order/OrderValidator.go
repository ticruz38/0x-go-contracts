...
//
// Solidity: function getOrderAndTraderInfo(Struct0 order, address takerAddress) constant returns(Struct1 orderInfo, Struct2 traderInfo)
func (_OrderValidator *OrderValidatorCaller) GetOrderAndTraderInfo(opts *bind.CallOpts, order Struct0, takerAddress common.Address) (struct {
	OrderInfo  Struct1
	TraderInfo Struct2
}, error) {
	ret := new(struct {
...
//
// Solidity: function getOrderAndTraderInfo(Struct0 order, address takerAddress) constant returns(Struct1 orderInfo, Struct2 traderInfo)
func (_OrderValidator *OrderValidatorSession) GetOrderAndTraderInfo(order Struct0, takerAddress common.Address) (struct {
	OrderInfo  Struct1
	TraderInfo Struct2
}, error) {
...
//
// Solidity: function getOrderAndTraderInfo(Struct0 order, address takerAddress) constant returns(Struct1 orderInfo, Struct2 traderInfo)
func (_OrderValidator *OrderValidatorCallerSession) GetOrderAndTraderInfo(order Struct0, takerAddress common.Address) (struct {
	OrderInfo  Struct1
	TraderInfo Struct2
}, error) {
	return _OrderValidator.Contract.GetOrderAndTraderInfo(&_OrderValidator.CallOpts, order, takerAddress)
...
//
// Solidity: function getOrdersAndTradersInfo([]Struct0 orders, address[] takerAddresses) constant returns([]Struct1 ordersInfo, []Struct2 tradersInfo)
func (_OrderValidator *OrderValidatorCaller) GetOrdersAndTradersInfo(opts *bind.CallOpts, orders []Struct0, takerAddresses []common.Address) (struct {
	OrdersInfo  []Struct1
	TradersInfo []Struct2
}, error) {
	ret := new(struct {
...
//
// Solidity: function getOrdersAndTradersInfo([]Struct0 orders, address[] takerAddresses) constant returns([]Struct1 ordersInfo, []Struct2 tradersInfo)
func (_OrderValidator *OrderValidatorSession) GetOrdersAndTradersInfo(orders []Struct0, takerAddresses []common.Address) (struct {
	OrdersInfo  []Struct1
	TradersInfo []Struct2
}, error) {
...
//
// Solidity: function getOrdersAndTradersInfo([]Struct0 orders, address[] takerAddresses) constant returns([]Struct1 ordersInfo, []Struct2 tradersInfo)
func (_OrderValidator *OrderValidatorCallerSession) GetOrdersAndTradersInfo(orders []Struct0, takerAddresses []common.Address) (struct {
	OrdersInfo  []Struct1
	TradersInfo []Struct2
}, error) {
	return _OrderValidator.Contract.GetOrdersAndTradersInfo(&_OrderValidator.CallOpts, orders, takerAddresses)
...
//
// Solidity: function getTraderInfo(Struct0 order, address takerAddress) constant returns(Struct2 traderInfo)
func (_OrderValidator *OrderValidatorCaller) GetTraderInfo(opts *bind.CallOpts, order Struct0, takerAddress common.Address) (Struct2, error) {
	var (
		ret0 = new(Struct2)
	)
	out := ret0
...
//
// Solidity: function getTraderInfo(Struct0 order, address takerAddress) constant returns(Struct2 traderInfo)
func (_OrderValidator *OrderValidatorSession) GetTraderInfo(order Struct0, takerAddress common.Address) (Struct2, error) {
...
//
// Solidity: function getTraderInfo(Struct0 order, address takerAddress) constant returns(Struct2 traderInfo)
func (_OrderValidator *OrderValidatorCallerSession) GetTraderInfo(order Struct0, takerAddress common.Address) (Struct2, error) {
	return _OrderValidator.Contract.GetTraderInfo(&_OrderValidator.CallOpts, order, takerAddress)
}

// GetTradersInfo is a free data retrieval call binding the contract method 0x690d3114.
//
// Solidity: function getTradersInfo([]Struct0 orders, address[] takerAddresses) constant returns([]Struct2)
func (_OrderValidator *OrderValidatorCaller) GetTradersInfo(opts *bind.CallOpts, orders []Struct0, takerAddresses []common.Address) ([]Struct2, error) {
	var (
		ret0 = new([]Struct2)
	)
	out := ret0
...
//
// Solidity: function getTradersInfo([]Struct0 orders, address[] takerAddresses) constant returns([]Struct2)
func (_OrderValidator *OrderValidatorSession) GetTradersInfo(orders []Struct0, takerAddresses []common.Address) ([]Struct2, error) {
...
//
// Solidity: function getTradersInfo([]Struct0 orders, address[] takerAddresses) constant returns([]Struct2)
func (_OrderValidator *OrderValidatorCallerSession) GetTradersInfo(orders []Struct0, takerAddresses []common.Address) ([]Struct2, error) {
	return _OrderValidator.Contract.GetTradersInfo(&_OrderValidator.CallOpts, orders, takerAddresses)
}
